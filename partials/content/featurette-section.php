<section class="featurette-section">
    <div class="featurette-section__inner">
        <div class="featurette-section__heading">
            <h2>Our Solutions</h2>
        ...
        <div class="row inline">
            <div class="col col-5 col-5-meta1">
                <div class="featurette-section__meta">
                    ...
                    <a href="<?php echo get_home_url(); ?>/our-solutions/vector-control/"
                       class="btn-call-to-action medium-margin-top">Learn More</a>
                </div>
            </div>
            <div class="col col-5"
        ...
        <div class="row inline">
            ...
            <div class="col col-5 col-5-meta2">
                <div class="featurette-section__meta">
                    ...
                    <a href="<?php echo get_home_url(); ?>/our-solutions/disinfection-sanitation/"
                       class="btn-call-to-action medium-margin-top">Learn More</a>
                </div>
            </div>
        </div>
        <div class="row inline">
            <div class="col col-5 col-5-meta1">
                <div class="featurette-section__meta">
                    ...
                    <a href="<?php echo get_home_url(); ?>/disaster-preparedness/"
                       class="btn-call-to-action medium-margin-top">Learn More</a>
                </div>
            </div>
            <div class="col col-5"
                 style="background: url(<?php echo the_field('backgorund_image_3'); ?>); background-position:center; background-size: cover;">
