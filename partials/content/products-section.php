<section class="products-section">
    ...
    <div id="sol" class="products-section__row mb-2" style="background: url(<?php echo the_field('product_1'); ?>)no-repeat left fixed; -o-background-size: cover; -moz-background-size: cover; -webkit-background-size: cover; background-size: cover;">
