<section class="what-we-offer-section"
         style="background:url('http://localhost/ishaglobal/wp-content/uploads/2021/04/homepage-section-3_02.jpg'); background-position:center; background-size: cover; background-attachment: fixed">
    <div class="what-we-offer-section__inner">
        <h2>What we offer</h2>
